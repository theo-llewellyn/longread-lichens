...
/rds/general/user/tbl19/home/blobtools/blobtools create \
 -i /rds/general/project/theollewellynproject/live/flye_sup_metagenome_assembly_${ACCESSION2}/assembly.fasta \
...
#-c /rds/general/project/theollewellynproject/live/BlobTools/bbmap_alignments/${ACCESSION}.sam.cov
